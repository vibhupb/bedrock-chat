...
# Note: These imports will work when the file is moved to backend/app/agents/tools/
...
class DataAnalystInput(BaseModel):
    prompt: str = Field(
        description="The data analysis question or query you want to ask. "
                   "Examples: 'What were the best selling games in the last 10 years?', "
                   "'Analyze market trends for mobile gaming', "
...
def analyze_data(
    arg: DataAnalystInput, bot=None, model=None
) -> dict:
    """
...
# When moved to backend/app/agents/tools/, uncomment this:
# data_analyst_tool = AgentTool(
#     name="analyze_data",
#     description="Analyze data using an external data analysis API. This tool can answer questions about gaming sales data, market trends, regional analysis, genre performance, and other data-driven insights. Perfect for queries about best-selling games, market analysis, sales trends, and comparative data analysis.",
